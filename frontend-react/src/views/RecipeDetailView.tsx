...
/**
 * Component for displaying the details of a recipe.
 *
 * This component fetches and displays the details of a recipe, including its ingredients,
 * description, and owner information. If the recipe is not found, it displays a placeholder.
 *
 * @returns {JSX.Element} The rendered component.
 */
function RecipeDetailView(): JSX.Element {
    ...
    return (
      <div>
        <Stack direction={"vertical"}>
          ...
          <img
            src="https://www.gluthelden.de/wp-content/uploads/2018/06/K%C3%A4seso%C3%9Fe-.jpg"
            className="img-fluid"
            alt={"dish"}
          />
          ...
          <IngredientsTable
            ingredients={[
              { name: "Käse", amount: 3, unit: "g" },
              { name: "Teig", amount: 100, unit: "g" }
            ]}
          />
